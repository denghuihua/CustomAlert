...
@interface SHIPresentBottomVC ()<UIViewControllerTransitioningDelegate,CAAnimationDelegate>
{
...
//    _containerView.transform = CGAffineTransformMakeScale(0.0, 0.0);
    ...
    [self.view.layer addAnimation:animationGroup forKey:@"scale"];
    [self.view.layer addAnimation:alphaAnimation forKey:@"alpha"]; 
